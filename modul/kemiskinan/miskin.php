<?php
$aksi = "modul/kemiskinan/aksi_kemiskinan.php";
$tahun = $_GET['tahun'];
?>

<section class="content-header">
    <h1>
        <i class=""></i>Keluarga Miskin <?php echo $tahun ?>
        <br><small>Daftar Keluarga Miskin</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="kemiskinan"> Keluarga Miskin</a></li>	
        <li><a href="kemiskinans-<?php echo $tahun ?>"> Keluarga Miskin-<?php echo $tahun ?></a></li>	
    </ol>
    <br>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Tambah</button>
    <button type="button" class="btn btn-warning" onclick="window.location = 'kemiskinan'"><i class="fa fa-arrow-circle-left"></i> Kembali</button>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Tambah Kemiskinan Baru</h4>
                </div>
                <div class="modal-body">
                    <?php
                    echo " <form  method='post' action='$aksi?module=kemiskinans&act=input'>";
                    ?>
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="">Jumlah Kemiskinan</label>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                            $tampil = mysql_query("select * from tabel_kemiskinan a, tabel_kecamatan b where a.id_kecamatan=b.id_kecamatan and  a.tahun='$tahun' order by a.id_kemiskinan ASC");
                            $no = 1;
                            while ($dt = mysql_fetch_array($tampil)) {
                                ...
                                <tr>
                                    ...
                                    <td>           
                                        ...
                                        <!-- Modal Update-->
                                        <?php
                                        $tampilx = mysql_query("select * from tabel_kemiskinan where id_kemiskinan='$id'");
                                        ...
                                        <div class="modal fade" id="edit<?php echo $id; ?>" role="dialog">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title">Ubah Data Keluarga Miskin</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="box-body">
                                                            <?php
                                                            echo " <form  method='post' action='$aksi?module=kemiskinans&act=edit'>";
                                                            ?> 
                                                            <input type="hidden" class="form-control" value="<?php echo $id ?>" name="id_kemiskinan" required="required">
                                                            <div class="form-group">
                                                                <label for="jenis">Kecamatan</label>
                                                                <select class="form-control" name="kecamatan" id="idkecamatan">
                                                                    <option selected="selected">- Pilih Kecamatan -</option>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <?php
                                                        echo " <form  method='post' action='$aksi?module=kemiskinans&act=hapus'>";
                                                        ?> 
                                                        <input type="hidden" class="form-control" value="<?php echo $id ?>" name="id_kemiskinan" required="required">
                                        ...
                                        <div class="modal fade" id="detail<?php echo $id; ?>" role="dialog">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title">Detail Data Keluarga Miskin</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="box-body">
                                                            <div class="form-group">
